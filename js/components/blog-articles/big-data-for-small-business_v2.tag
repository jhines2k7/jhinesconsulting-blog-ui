<big-data-for-small-business>
    ...
    <p>In days past, aggregating data from various sources has been so resource intensive in terms of compute power
        ...
        aggregated by hand, it becomes prohibitively expensive for small and midsized businesses. In 2020, your small
    ...
    <div class="important_content"><h3> Ultimately, you'll want to be able to ask questions in plain English, and get
        answers that are easy to understand. That's where I believe I can help.</h3></div>
    ...
    <p> A 360&#176; customer view is only the beginning. Once you've begun the process of centralizing your data you
