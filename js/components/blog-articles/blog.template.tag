<blog-template>
    ...
    <p>
        One of the most compelling use cases for "Big Data" is to create what is called a 360 degree view of a customer.
        This is the idea that a company can get a more complete view of their customers by aggregating data from the
        various touch points customers may use to contact a company to purchase products or to receive service and support.
    </p>
    <p>
        This 360-degree view can help businesses determine what kinds of products or services their customers might buy
        next, or do a better job of targeting messages to specific groups of customers.
    </p>
    <p>In days past, aggregating data from various sources has been so resource intensive in terms of compute power
        ...
        services is that you only pay for what you use.
    </p>
    <div class="important_content">
        <h3>
            Ultimately, you'll want to be able to ask questions in plain English, and get answers that are easy to
            understand. That's were I believe I can help
        </h3>
    </div>
    <p>
        Now that you know it's possible for your small business to automate the process of aggregating customer data
